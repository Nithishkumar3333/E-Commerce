...
import fashionmodel from "../../assets/young-fashion-man-woman.webp";
...
const Appbar = () => {
  return (
    <>
      ...
      <section className="bg-[#F2F0F1] w-full mt-9 flex items-center justify-center">
        <div className="md:w-1/2 p-8">
          <div className="mb-4">
            ...
            <p className="mt-2 text-gray-700">
              ...
              repudiandae sapiente facilis soluta quam impedit consectetur
            </p>
          </div>
          <div className="mb-4 md:text-start text-center">
            <button className="bg-black  text-white font-bold py-2 px-20 rounded-full">
              Button
            </button>
          </div>
          <div className="grid md:grid-cols-3 grid-cols-2 gap-1 ">
            <div className=" items-center justify-center flex-col border border-r-gray-500 ">
              <div className="text-2xl font-bold">200+</div>
              <div className="">International brands</div>
            </div>
            <div className=" items-center justify-center flex-col border md:border-r-gray-500">
              <div className="text-2xl font-bold ">2,000+</div>
              <div className="">High-Quality Products</div>
            </div>
            <div className="flex items-center justify-center flex-col md:col-span-1 col-span-2 md:border-r-gray-500 border-t border-l-gray-500">
        ...
        <div className="hidden md:block md:w-1/2">
          <img src={fashionmodel} alt="Image" className="w-full h-auto" />
        </div>
      </section>
      ...
      <div className=" bg-black w-full text-white  font-bold h-40  flex items-center text-xs md:text-3xl lg:text-4xl xl:text-6xl lg:justify-evenly justify-evenly lg:space-x-10 ">
        <div className="md:font-thin">VERSACE</div>
        <div className="font-serif">ZARA</div>
        <div className="font-mono">GUCCI</div>
        <div className="font-serif">PRADA</div>
        <div className="md:font-thin">Calvin Klein</div>
      </div>

      {/* NEW ARRIVALS */}
      <div className="text-center mt-10 font-bold text-2xl md:text-3xl lg:text-5xl">
        NEW ARRIVALS
      </div>

      <div className="md:flex ">
        <div className="relative mx-auto md:m-2 lg:m-5 xl:m-auto flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
          <a
      ...
      <div className="flex justify-center">
        <div className="text-center rounded-full px-20 py-2 md:mt-5 border border-gray-400 border-">
          View All
        </div>
      </div>
      ...
      <div className="flex justify-center">
        <div className="text-center rounded-full px-20 py-2 mb-20 md:mt-5 border border-gray-400 border-">
          View All
        </div>
      </div>

      <div className="bg-[#F2F0F1] rounded-3xl">
        <div className="text-center py-10 text-2xl md:text-3xl lg:text-5xl  font-bold">
          BROWSE BY DRESS STYLE
        </div>
        <div className="flex flex-wrap justify-center space-x-5">
          <div className="mt-0 relative">
            <img
              className="  object-cover mb-5 h-48 md:w-50 rounded-lg"
              src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
              alt="product image"
            />
            <span className="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">
          ...
          <div className="mt-0 relative">
            <img
              className="object-cover mr-5 md:m-0 h-48 md:w-96 rounded-lg"
              src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
              alt="product image"
            />
            <span className="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">
        ...
        <div className="flex flex-wrap justify-center py-5 space-x-5">
          <div className="mt-0 relative">
            <img
              className="object-cover mb-5 h-48 md:w-96 rounded-lg"
              src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
              alt="product image"
            />
            <span className="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">
          ...
          <div className="mt-0 relative">
            <img
              className="object-cover mr-5 md:m-0 h-48 md:w-50 rounded-lg"
              src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
              alt="product image"
            />
            <span className="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center">
            <div className="text-start">
              <h2 className="mt-4 text-3xl font-extrabold text-black sm:text-4xl xl:text-5xl">
                OUR HAPPY CUSTOMERS{" "}
              </h2>
            </div>
