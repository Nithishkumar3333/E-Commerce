...
const filter = [
  {
    ...
    options: [
      ...
      { value: "Hoodie outfit", label: "Hoodie outfit", checked: false },
      { value: "Chinos", label: "Chinos", checked: true },
      {
        value: "Elevated casualwear",
        label: "Elevated casualwear",
        checked: false,
      },
      {
        value: "Unstructured blazer",
        label: "Unstructured blazer",
        checked: false,
      },
      { value: "Merino Knit", label: "Merino Knit", checked: false },
    ],
  },
  {
    id: "Formal",
    ...
    options: [
      ...
      { value: "Suit", label: "Suit", checked: false },
      {
        value: "Slim wool suit pant",
        label: "Slim wool suit pant",
        checked: true,
      },
  ...
  },
  {
    ...
    name: "Party",
    options: [
      { value: "Sherwani", label: "Sherwani", checked: false },
      { value: "Kurta Jacket Set", label: "Kurta Jacket Set", checked: false },
      { value: "Indo Western", label: "Indo Western", checked: false },
      {
        value: "Embroidered art silk jodhpuri suit",
        label: "Embroidered art silk jodhpuri suit",
        checked: false,
      },
      {
        value: "Navy blue embellished sherwani set",
        label: "Navy blue embellished sherwani set",
        checked: false,
      },
    ],
  },
  {
    ...
    options: [
      ...
      { value: "Gym Bag", label: "Gym Bag", checked: false },
      { value: "Sweatpants", label: "Sweatpants", checked: false },
      { value: "Gym Vest", label: "Gym Vest", checked: false },
...
export default function Example() {
  ...
  return (
    <>
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                ...
                <form className="mt-4 border-t border-gray-200">
                  ...
                  <hr />
                  <div class="relative mb-10 m-5">
                    <h2 className="text-lg font-bold text-gray-900 py-5">
                      price{" "}
                    </h2>
                ...
                <h2 className="text-lg font-bold text-gray-900 py-5 ml-5">
                  Dress Style{" "}
                </h2>
                {filter.map((section) => (
                  <Disclosure
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="products-heading" className="pb-14 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4 ">
                {/* Filters */}
                <form className="hidden lg:block p-5 border">
                  <h3 className="sr-only">Categories</h3>
                  <div className="flex justify-between ">
                    <h2 className="text-lg font-bold text-gray-900 mb-5">
                      Filters{" "}
                    </h2>
                    <BsSliders2Vertical className="mt-1 font-bold" />
                  </div>
                  <hr className="mb-5" />
                ...
                <div className="lg:col-span-3 ">
                  <div className="md:flex ">
                    <div className="relative mx-auto md:m-2 lg:m-5 xl:m-auto flex w-full max-w-xs flex-col overflow-hidden rounded-lg ">
                      <a
      ...
      <div className="bg-black h-auto w-auto md:mx-20  text-white rounded-lg flex-wrap flex items-center justify-center">
