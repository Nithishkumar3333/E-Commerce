...
const ProductDetailPage = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
            ...
            <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
              <h1 className="sm: text-2xl font-extrabold text-gray-900 sm:text-3xl uppercase">
              ...
              <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                <div className="flex items-center border boder-2 h-10 w-20 rounded-lg">
                  <button
                    type="button"
                  ...
                  <input
                    ...
                    id="counter-input-5"
                    data-input-counter
                    className="w-10  shrink-0 border-0  text-center text-sm font-medium text-black focus:outline-none focus:ring-0 "
                    placeholder=""
                    value="1"
                    required
                  />
          ...
          <section className="py-12 sm:py-16 ">
            <div className="container mx-auto px-4 ">
              <div className="lg:col-gap-12 xl:col-gap-16 mt-8  gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16 ">
                <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2 ">
                  <div className="border-b border-t py-4 ">
                    <div className="space-x-4">
                      <button
                        className={`inline-block pb-2 font-medium text-gray-900 ${
                          ...
                          <div class="flex flex-col items-center">
                            <div class="relative mt-10 md:order-2 md:mt-24">
                                    ...
                                    <div class="flex-1">
                                      ...
                                      <blockquote class="mt-8 flex-1">
                                        <p class="font-[400] text-xl italic text-blue-900">
                                          ...
                                          ducimus repellat aperiam quam
                                          consequatur eligendi totam vitae iusto
                                          mollitia esse.”
                                        </p>
                                      </blockquote>
                                    </div>
                              ...
                              <div className="flex justify-center">
                                <div className="text-center rounded-full md:px-20 px-10 mt-5 py-2 text-xs md:mt-5 border border-gray-400 ">
                                  Load More Reviews
                                </div>
                              </div>
                            </div>
      ...
      <div className="text-center font-bold text-2xl md:text-3xl lg:text-5xl">
        TOP SELLING
      </div>
